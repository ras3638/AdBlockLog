...
public class Proxy extends Service implements Runnable {
	...
	static ArrayList<String> urlArrayListFormat = new ArrayList<String>();
			...
			try {
				...
				while (this.local.isConnected()) {
					...
					if (url != null) {
						...
						url2 = url.toString() + "zxcv";

						// rethink this strategy
						if (AdBlock.ENABLE == true) {
							Proxy.urlArrayList.add(url.toString());
							Proxy.urlArrayListFormat.add(url2);
	...
	public final void onStart(final Intent intent, final int startId) {
		...
		notification.setLatestEventInfo(this,
				this.getString(R.string.notify_proxy), "", contentIntent);
